 ...
 */
final class Version20250508193004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE carte_double (id INT AUTO_INCREMENT NOT NULL, compte_id INT NOT NULL, carte_id INT NOT NULL, nombre INT NOT NULL, INDEX IDX_CC0392DEF2C56620 (compte_id), INDEX IDX_CC0392DEC9C7CEB6 (carte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
