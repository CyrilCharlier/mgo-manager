...
class ResetPasswordController extends AbstractController
{
    ...
    public function request(Request $request, MailerInterface $mailer, TranslatorInterface $translator, RateLimiterFactory $passwordResetLimiter): Response
    {
        ...
        if (!$limit->isAccepted()) {
            throw new TooManyRequestsHttpException(null, 'Trop de tentatives de réinitialisation. Veuillez patienter avant de réessayer.');
        }
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('mgo@charlier.cloud', 'MGM Manager - No Reply'))
